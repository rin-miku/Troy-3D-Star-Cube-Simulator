...
/// 0 -1 0
/// </summary>
public static class RightSurface
{
    ...
    {
        cwRotationMatrix.SetRow(0, new Vector4(1, 0, 0, 0));
        cwRotationMatrix.SetRow(1, new Vector4(0, 0, -1, 0));
        cwRotationMatrix.SetRow(2, new Vector4(0, 1, 0, 0));
        cwRotationMatrix.SetRow(3, new Vector4(0, 0, 0, 0));

        ccwRotationMatrix.SetRow(0, new Vector4(1, 0, 0, 0));
        ccwRotationMatrix.SetRow(1, new Vector4(0, 0, 1, 0));
        ccwRotationMatrix.SetRow(2, new Vector4(0, -1, 0, 0));
        ccwRotationMatrix.SetRow(3, new Vector4(0, 0, 0, 0));
    }

    private static void InitPieces()
    {
        piecesCoord.Add(new Vector3Int(1, 0, 0));
